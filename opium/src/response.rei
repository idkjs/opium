...
let cache_control: t => option(string);
...
let set_cache_control: (string, t) => t;
...
let cookie: (~signed_with: Cookie.Signer.t=?, string, t) => option(Cookie.t);
...
let cookies: (~signed_with: Cookie.Signer.t=?, t) => list(Cookie.t);
