...
module Middleware: {
  ...
  let router: Router.t(Rock.Handler.t) => Rock.Middleware.t;
  ...
  let debugger: Rock.Middleware.t;
  ...
  let content_length: Rock.Middleware.t;
  ...
  let method_override: Rock.Middleware.t;
  ...
  let method_required:
    (~allowed_methods: list(Method.t)=?, unit) => Rock.Middleware.t;
